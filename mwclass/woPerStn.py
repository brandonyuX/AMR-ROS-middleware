...
class WOPerStn:
    def __init__(self, woid=None, batchNum=None, woNum=None, manufactureDate=None, fnpDate=None, initSerialNum=None, requireQty=None, processedQty=None, startTime=None, endTime=None, status=None, fillVol=None, targetTor=None, orderNum=None,state=None,expdate=None) -> None:
        self.woid=woid
